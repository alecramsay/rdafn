...
from rdafn.analyze import analyze_plan, analyze_plan_TOPO, index_counties_and_districts
...
class TestScorecard:
    ...
    # TODO - DELETE
    def test_scorecard_TOPO(self) -> None:
        for xx in ["NC", "NJ"]:
            plan_path: str = f"{data_dir}/{xx}/{xx}20C_baseline_100.csv"
            ...
            scorecard: dict[str, Any] = analyze_plan_TOPO(
                assignments,
                data,
                state_topo,
                D,
